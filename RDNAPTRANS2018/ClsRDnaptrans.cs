...
Version:
1.0 - 20191002: Fred Vellinga, Initial version. Contact fred.vellinga@kandan.nl
*/
...
namespace RDNAPTRANS2018
{
  ...
  class ClsRDnaptrans
  {
    ...
    public string rdcorr2018_file = "";             // path the the grid files and validation files
    ...
    /// <param name="pRows">Number of rows to read</param>
